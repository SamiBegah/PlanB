...
const AdminPortal = ({ fields }) => {
  ...
  return (
    <div className="py-40 px-20 flex flex-col">
      <h3 className=" font-bold text-blue-950">
        Bienvenue au portail administrateur,
      </h3>
      <div className=" text-center flex  gap-10 justify-center items-center w-full  rounded-lg pb-20  ">
        <button
          className="text-start p-5 bg-blue-500 rounded shadow-xl text-white"
          onClick={() => {
            setActiveMenu("jobs");
          }}
        >
        ...
        <button
          className="text-start p-5 bg-blue-950 rounded shadow-xl text-white"
          onClick={() => {
      ...
      {activeMenu == "jobs" ? (
                  ...
                  {jobPostings?.map((job) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <small className=" top-2 right-2 text-end ">
                          {job.id}
                        </small>
                      </div>
        ...
        <div className="bg-black bg-opacity-10  p-10 rounded-xl shadow-inner w-full h-[900px]">
          {/* Employees */}
          {membersList.map((member, index) => {
            console.log(member);
            return (
              <div
                className="bg-white p-5 rounded shadow-xl flex items-center justify-between "
                key={index}
              >
                ...
                <div className="flex gap-2 justify-center items-center text-white">
                  <button className="p-2 px-5 hover:font-bold  bg-blue-950 rounded shadow scale-95 hover:scale-100 transition-all">
                    Voir les candidatures
                  </button>
                  <button className="p-2 px-5 hover:font-bold  bg-blue-500 rounded shadow scale-95 hover:scale-100 transition-all">
                    Contacter
                  </button>
                  <button className="p-2 px-5 hover:font-bold  bg-gray-500 rounded shadow scale-95 hover:scale-100 transition-all">
                    Supprimer
                  </button>
                </div>
              </div>
